            ...
            <ul class="sidebar-menu" data-widget="tree">  
              ...
              <li class="treeview {{ ($prefix == 'setup')?'active':'' }} ">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="{{ route('registration.fee.view') }}"><i class="ti-more"></i>Registration Fee View</a></li>
                  <li><a href="{{ route('monthly.fee.view') }}"><i class="ti-more"></i>Monthly Fee View</a></li>
                  <li><a href="{{ route('exam.fee.view') }}"><i class="ti-more"></i>Exam Fee View</a></li>
                </ul>
              </li>
