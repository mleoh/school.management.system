   ...
   <body>
    ...
    <table id="customers">
        <tr>
            ...
            <td>
                ...
                <p>School Address</p>
                <p>Phone : 0712787749</p>
                <p>Email : smleohgmail.com</p>
    ...
    @endphp 
        ...
        <table id="customers">
            ...
            <tr>
                <td>9</td>
                <td><b>Fee For this Student of {{ $exam_type_id }} </b></td>
                <td>$ {{ $finalfee }} </td>
            </tr>
             ...
             <br>
                <hr style="border: line 2px; width: 95%; color: #ddd; margin-bottom: 50px">
