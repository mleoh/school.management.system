												...
												<div class="col-12">	
															...
															<div class="form-group">
																...
																<div class="controls">
																	<select name="religion" id="religion" required="" class="form-control">
																		...
																		<option value="Christ" {{ ($editData['student']['religion'] == 'Christ')? 'selected':''}}>Christian</option>
													...
													<div class="row"><!-- 5th row-->
														...
														<div class="col-md-4">
															<div class="form-group">
																<div class="controls">
																<img id="showImage" src="{{ (!empty($editData['student']['image']))? 
                                                                url('upload/student_images/'.$editData['student']['image']):url('upload/no_image.jpg') }}"  
